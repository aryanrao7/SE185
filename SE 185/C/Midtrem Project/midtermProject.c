...
1- Student 1 - TEJAL DEVSHETWAR 
          Role: Quiz Creator and Coding - Participation: 50%
I created the questions for all the quizes,  did some debugging, corrected some logical mistakes and helped to write the code.
2- Student 2 - ARYAN RAO
          Role: Debugger and Coding- Participation: 50%
I implemented the logic behind the code, did some debugging and wrote the code.
3-
4-
5-																                                     -
-----------------------------------------------------------------------------*/
...
int main(int argc, char *argv[])
{
  ...
  int marks3_2 = 0;
  int marks3_3 = 0;
  char c1_1[5],c1_3[5],c1_4[5],c2_1[5],c2_2[5],c2_3[5],c2_4[5],c2_5[5],c3_1[5],c3_2[5],c3_3[5],c3_4[5];
  double t1,t2,t3;
  srand(time(0));
